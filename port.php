...
if($artifactcount > 0)
{
	...
	for($myLoop=0; $myLoop<=$artifactcount-1; $myLoop++)
	{
		echo "<td align=center valign=top class=nav_title_12>";
		echo "<a href=\"artifact_grab.php?artifact_id=$artifact_id[$myLoop]\" onMouseover=\"ddrivetip('" . $artifactname[$myLoop] . "','" . $artifact_description[$myLoop] . "');\" onMouseout=\"hideddrivetip()\">";
		echo "<img src=\"images/artifacts/$artifactimage[$myLoop].gif\" border=0></a><BR>";
		echo "<br><b>(<font color=#33ff00>$artifactname[$myLoop]</font>)</b>";
		echo "</td>";
